...
using WellBeing360.IdentityService.Repositories;
using WellBeing360.IdentityService.Repositories.Interfaces;
using WellBeing360.IdentityService.Services;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "WellBeing360.IdentityService", Version = "v1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "WellBeing360.IdentityService v1"));
}
